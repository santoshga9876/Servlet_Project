...
<ul>
	...
	<form action="add" method="post">
			...
			<input class="input" type="text" name="dob" placeholder="Enter Date Of Birth Here">
			...
			<input class="input" type="text" name="mobile" placeholder="Enter Mobile No. Here">
			...
			<label>Live City :-</label>
			<input  type="text" name="city" placeholder="Enter Live City Here">
			
			<label>Pincode :-</label>
			<input  type="text" name="pincode" placeholder="Enter Pincode Here">
			
			<input type="submit" value="AddEmployee" id="register">
